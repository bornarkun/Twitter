...
//  Twitter
//
//  Created by Kevin Ho on 2/20/16.
...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    static let sharedInstance = TwitterClient(baseURL: NSURL(string: "https://api.twitter.com")!, consumerKey: "Ko5fYSoUgjninVNyITVaizFQN", consumerSecret: "EWKvewYiUdoPgTBciLRHFktHZrqReEqF0QLNBOGMMMvjR044Vs")
