...
class DetailViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let whoIsSender = (sender is UIButton ? true : false)
        
        if whoIsSender {
        
            let theirProfileViewController = segue.destinationViewController as! TheirProfileViewController
    
        theirProfileViewController.tweet = tweet
